...
<form class="woocommerce-cart-form | mb-16" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
		...
		<div class="cart__coupons | grid gap-y-2 md:flex md:justify-between text-sm md:text-base">
			...
			<button type="submit" class="button | bg-red | text-white font-bold font-expanded" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
