      ...
      value: function addEvents() {
        ...
        if (this.menuBtn && this.menuItems) {
          this.menuBtn.on('click', function () {
            if (_this.menuItems.hasClass('is-open')) {
              _this.menuItems.addClass('h-0');

              _this.menuItems.removeClass('is-open max-h-full h-full');
            } else {
              _this.menuItems.addClass('is-open max-h-full h-full');

              _this.menuItems.removeClass('h-0');
            }
          });
        }
      }
...
swiper__WEBPACK_IMPORTED_MODULE_2__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_2__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_2__["Thumbs"], swiper__WEBPACK_IMPORTED_MODULE_2__["Lazy"], swiper__WEBPACK_IMPORTED_MODULE_2__["Controller"]]); // Artistas Carousel

if (document.querySelector(".artistas-carousel")) {
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".artistas-carousel", {
    slidesPerView: 4,
    spaceBetween: 1,
    navigation: {
      nextEl: ".swiper-button-next",
...
if (document.querySelectorAll(".product-slider__carousel").length > 0) {
  ...
  var thumbSwiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".thumb-slider__carousel", {
    spaceBetween: 10,
    slidesPerView: 5,
    freeMode: false,
    watchSlidesVisibility: true,
  ...
  var productSwiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".product-slider__carousel", {
    spaceBetween: 0,
...
window.zoomer = function zoom(event, offsetX, offsetY, x, y) {
  ...
  if (dataBg !== imgBg) {
    zoomer.style.backgroundImage = "url(\"".concat(dataBg, "\")");
...
var botomFooter = function botomFooter() {
