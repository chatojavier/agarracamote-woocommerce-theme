...
$image2x 			= wp_get_attachment_image_srcset( $campaign_img_id, 'shop_single');
...
<div class="campaign relative">
	<div class="relative">
		<img src="<?php echo $image1x; ?>" srcset="<?php echo $image2x; ?>" sizes="(min-width: 1024px) 300px, (min-width: 768px) 30vw, 45vw"  alt="<?php echo esc_html( $image_alt ); ?>" loading="lazy" >
	</div>
