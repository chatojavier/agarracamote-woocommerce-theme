...
>>>>>>> e6907218f1ea6673641c8b25789098bd4a0c9662
    ...
    <div class="artist-info">
        ...
        <div class="artist-title flex justify-between py-2 border-b-1 border-solid">
            ...
            <?php if($instagram) : ?>
            <div class="artist-instagram w-6">
                <a href="<?php echo $instagram ?>">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 21 21">
                    <g>
                        <path class="st0 text-red fill-current" d="M10.4,20.7c-1.1,0-2.1,0-3.2,0c-0.9,0-1.8,0-2.7-0.3c-1.5-0.4-2.7-1.2-3.5-2.5c-0.4-0.7-0.6-1.5-0.7-2.3
                        ...
                        <path class="st0 text-red fill-current" d="M15.7,10.5c0,2.9-2.3,5.2-5.2,5.2c-2.9,0-5.3-2.3-5.3-5.2c0-2.9,2.3-5.2,5.2-5.2C13.3,5.3,15.7,7.6,15.7,10.5
                            M10.4,13.9c1.9,0,3.4-1.5,3.4-3.5c0-1.8-1.6-3.3-3.4-3.3C8.5,7.1,7,8.7,7,10.6C7,12.4,8.6,13.9,10.4,13.9"/>
                        <path class="st0 text-red fill-current" d="M14.6,5.1c0-0.7,0.6-1.2,1.2-1.2c0.7,0,1.2,0.6,1.2,1.2c0,0.7-0.5,1.2-1.2,1.2C15.2,6.3,14.6,5.8,14.6,5.1"/>
                    </g>
                </svg>
                </a>
            </div>
